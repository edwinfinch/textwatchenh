/*
Custom text watch request (name, idk)
Suggested by /u/ASonOfIceAndFire
...
void bt_handler(bool connection){
	if(!connection){
		vibes_long_pulse();
	}
	else{
...
static void init() {
	...
	// 3rd layers
	line3.currentLayer = text_layer_create(GRect(0, 90, 144, 50));
	line3.nextLayer = text_layer_create(GRect(144, 90, 144, 50));
	...
	//Bluetooth/battery functionality
